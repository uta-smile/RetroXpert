...
def get_changed_atoms(reactants, products, v):
...
def process_an_example(reaction_smiles, super_general=False, v=False):
    ...
    try:
        ...
        changed_atoms, changed_atom_tags, err = get_changed_atoms(reactants, products, v)
        ...
        try:
            ...
            reactant_fragments, intra_only = get_fragments_for_changed_atoms(
                reactants, changed_atom_tags, radius=1, expansion=[], category='reactants', super_general=super_general)
            ...
            product_fragments, _ = get_fragments_for_changed_atoms(
                products, changed_atom_tags, radius=0,
...
for i, r in enumerate(rxn):
    res = process_an_example(r, super_general=True, v=True)
    print(res)
